  ...
  espConfig =
    ...
    in
    {
      dimmer1 =
        let
          globals = {
            lastDirection_W = "lastDirection_W";
            lastDirection_U = "lastDirection_U";
            lastDirection_P = "lastDirection_P";
            lastDirection_T = "lastDirection_T";
            lastDirection_X = "lastDirection_X";
          };
        in
        {
          substitutions = {
          ...
          globals =
            ...
            in
            [
              (mkBoolean globals.lastDirection_W)
              (mkBoolean globals.lastDirection_U)
              (mkBoolean globals.lastDirection_P)
              (mkBoolean globals.lastDirection_T)
              (mkBoolean globals.lastDirection_X)
            ];
          binary_sensor = [
            {
              platform = "gpio";
